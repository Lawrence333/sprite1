...
public void initialize(SEResourceCache rsc)
    {
		...
		bg.move(0,0);
		rsc.prepare_image("myimage","myimage",get_scene_width()*0.1,get_scene_height()*0.1);
			...
			if (fg.get_y() + fg.get_height() > get_scene_height()) 
				{
					...
					speed=100;
				    bounce++;
				    text.set_text("Bouncing Rectangle = %d".printf().add(Primitive.for_integer(bounce)).to_string());	
	            }
	            speed+=50;
	    }
